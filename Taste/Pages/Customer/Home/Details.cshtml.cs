...
namespace Taste.Pages.Customer.Home
{
    ...
    public class DetailsModel : PageModel
    {
        ...
        [BindProperty] public ShoppingCart ShoppingCartObj { get; set; }
        ...
        public IActionResult OnPost()
        {
            if (ModelState.IsValid)
            {
                ...
                ShoppingCart cartFromDb = _unitOfWork.ShoppingCart.GetFirstOrDefault(s =>
                    s.ApplicationUserId == ShoppingCartObj.ApplicationUserId
                    && s.MenuItemId == ShoppingCartObj.MenuItemId);
